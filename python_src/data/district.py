class District:
    def __init__(self, code=0, name="", region="", n_inhab=0, n_mun_inhab_0_499=0, n_mun_inhab_500_1999=0, n_mun_inhab_2000_9999=0, n_mun_inhab_10000_inf=0, n_cities=0, ratio_urban_inhab=0, average_salary=0, unemploymant_95=0, unemploymant_96=0, n_enterp_per_1000=0, n_crimes_95=0, n_crimes_96=0):
        ...
        if ratio_urban_inhab != "?":
            ...
            self.ratio_urban_inhab = ratio_urban_inhab
    ...
    def print(self):
        print(str(self.code) + " | " + self.name + " | " + self.region + " | " + str(self.n_inhab) + " | " + str(self.n_mun_inhab_0_499) + " | " + str(self.n_mun_inhab_500_1999) + " | " + str(self.n_mun_inhab_2000_9999) + " | " + str(self.n_mun_inhab_10000_inf) + " | " +
              str(self.n_cities) + " | " + str(self.ratio_urban_inhab) + " | " + str(self.average_salary) + " | " + str(self.unemploymant_95) + " | " + str(self.unemploymant_96) + " | " + str(self.n_enterp_per_1000) + " | " + str(self.n_crimes_95) + " | " + str(self.n_crimes_96))
